...
Recently, a number of studies have shown that Feedforward Neural Networks achieve high performance in HAR\cite{chen2018distilling}. A FNN is made up of a set of neurons, connected by weighted arcs, that process the input
information:
