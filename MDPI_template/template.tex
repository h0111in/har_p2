...
\begin{table}[H]
	...
	\begin{tabular}{ccccc}
		...
		Ab crunch machine& 3& 12& 108 & 10580\\
...
\begin{figure}[H]
	\centering
	\includegraphics[width=14 cm]{Definitions/images/boxplot_overall_accuracy_3.jpeg}
...
\begin{table}[H]
	\caption{The distribution of activities, repetitions, and subjects among three evaluation methods}
	\centering
	\begin{tabular}{p{4cm}p{2.7cm}p{2.7cm}p{2.7cm}}
		\toprule
		\textbf{Evaluation Method} & \textbf{\# Activities} & \textbf{\# Repetitions} & \textbf{\# Subjects}\\
		\midrule
		K-Fold &  8 & 10 & 13 \\
		LOTO & 7 & 4 & 6 \\
		LOSO & 5 & 4 & 4 \\
